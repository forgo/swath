...
(5 vs. 4); TiTiler and xpublish-tiles share rung 3 with Swath's design center —
...
Swath lacks. **openEO backends:** authoring breadth — the top of the ladder
(Swath's bounded profile is honestly one rung below); upfront cost estimation
before a job runs; a multi-implementation standard with official client
