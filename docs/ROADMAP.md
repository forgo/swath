...
| 4 | **Learned planner cost model** | `docs/design/materialization-planner.md` §6, `crates/swath-core/src/planner.rs` | The x-ray contract (R4) demands explainable choices; the Trace already carries the training pairs | A Trace corpus shows the fixed estimate constants materially wrong |
