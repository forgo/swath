...
3. **Time dimension** (inventory row 7). The charter promises "animate a time series"; it is
   ...
   by ADR 0015 (frame selection); serving side shipped by #180, graph-side windows in #181.*
