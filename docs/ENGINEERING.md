...
All crates stay `publish = false`; installers, `cargo auditable`, and attestation (SLSA L2) are
graduation-tier. Conventional commits via squash-only merges + PR-title lint — squashed titles
